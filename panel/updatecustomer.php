...
<body oncontextmenu="return false;" id="page-top">
    ...
    ?>
        ...
        <div id="wrapper">
            ...
            <!-- Begin Page Content -->
            <div style="margin-bottom: 125px;" class="container-fluid ">
                <!-- Page Heading -->
                <h1 class="h3 mb-2 text-gray-800">Update Customer</h1>
                <hr>
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold ">Update Customer Details</h6>
                    </div>
                    <div class="card-body">
                        ...
                        ?>
                        <form class="row g-3" method="post" action="./assets/updatecustomer.php" enctype="multipart/form-data">
                            ...
                            <div class="col-md-6">
                                <label class="form-label mt-3">Customer's Profile</label>
                                <input type="file" name="customerprofile" class="form-control" id="inputGroupFile04" aria-describedby="inputGroupFileAddon04" aria-label="Upload">
                            </div>
